...
{
    public class Map : IManager, IDisposable
    {
        ...
        public string TransformToCellId(string[] cellsDirection)
        {
            ...
            for (int i = 0; i < cellsDirection.Length; i++)
            {
                ...
                {
                    case "RIGHT":
                        st.Append(CellsTeleport[MovementDirection.RIGHT].First());
                        break;
                    case "LEFT":
                        st.Append(CellsTeleport[MovementDirection.LEFT].First());
                        break;
                    case "TOP":
                        st.Append(CellsTeleport[MovementDirection.TOP].First());
                        break;
                    case "BOTTOM":
