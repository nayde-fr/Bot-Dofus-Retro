...
namespace Bot_Dofus_1._29._1.Common.Frames.Game
{
    ...
    {
        [PacketHandler("M030")]
        public void StreamingErrorPacketHandle(TcpClient prmClient, string prmRawPacketData)
        {
        ...
        [PacketHandler("M031")]
        public void NetworkErrorPacketHandle(TcpClient prmClient, string prmRawPacketData)
        {
        ...
        [PacketHandler("M032")]
        public void FloodConnexionErrorPacketHandle(TcpClient prmClient, string prmRawPacketData)
        {
