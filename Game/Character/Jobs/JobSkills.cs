...
namespace Bot_Dofus_1._29._1.Game.Character.Jobs
{
    public class JobSkills
    {
        ...
        public InteractiveObjectModel interactivo_modelo { get; private set; }
        ...
        public JobSkills(short _id, byte _cantidad_minima, byte _cantidad_maxima, float _tiempo)
        {
            ...
            InteractiveObjectModel _modelo = InteractiveObjectModel.get_Modelo_Por_Habilidad(id);
            if (_modelo != null)
            {
