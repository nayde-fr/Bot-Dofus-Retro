...
namespace Bot_Dofus_1._29._1.Game.Mapas
{
    public class Cell
    {
        ...
        public Cell(short prmCellId, bool prmIsActive, CellTypes prmCellType, bool prmIsInLineOfSight, byte _nivel, byte _slope, short prmInteractiveObjectId, short _layer_object_1_num, short _layer_object_2_num, Map prmMap)
        {
            ...
            {
                interactiveObject = new InteractiveObject(prmInteractiveObjectId, this);
        ...
        public bool IsInteractiveWalkable() => cellType == CellTypes.INTERACTIVE_OBJECT || interactiveObject != null && !interactiveObject.Model.caminable;
    }
}
