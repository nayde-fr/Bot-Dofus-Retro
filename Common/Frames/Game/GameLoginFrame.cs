...
namespace Bot_Dofus_1._29._1.Common.Frames.Game
{
    ...
    {
        [PacketHandler("M030")]
        public void GetStreamingError(TcpClient prmClient, string prmRawPacketData)
        {
        ...
        [PacketHandler("M031")]
        public void GetNetworkError(TcpClient prmClient, string prmRawPacketData)
        {
        ...
        [PacketHandler("M032")]
        public void GetFloodConnexionError(TcpClient prmClient, string prmRawPacketData)
        {
